...
Perform maximum likelihood-based analysis of haplotypes to infer chromosome ancestry using ChromoPainter. Note: it is important to disable self-copying to allow detection of foreign intriogressions in populations founded by admixture.
